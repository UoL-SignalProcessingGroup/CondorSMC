...
![GitHub repo size](https://img.shields.io/github/repo-size/mjcarter95/CondorSMC)
![GitHub contributors](https://img.shields.io/github/contributors/mjcarter95/CondorSMC)
![GitHub stars](https://img.shields.io/github/stars/mjcarter95/CondorSMC?style=social)
![GitHub forks](https://img.shields.io/github/forks/mjcarter95/CondorSMC?style=social)

CondorSMC is a Python package that allows users to sample from target densities using an opportunistic Sequential Monte Carlo sampler that is distributed on HTCondor. 
...
## Contact
If you want to contact me you can reach me at <mcarter (at) liverpool (dot) ac (dot) uk>.
